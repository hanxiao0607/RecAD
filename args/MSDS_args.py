...
def arg_parser():
    ...
    # GVAR
    parser.add_argument('--lambda', type=float, default=3)
    ...
    parser.add_argument('--hidden-layer-size', type=int, default=20, help='Number of units in the hidden layer (default: 50)')
    ...
    parser.add_argument('--recourse_model_hidden_dim', type=int, default=100)
    ...
    parser.add_argument('--ad_model_alpha', type=float, default=0.0)
    parser.add_argument('--ad_model_beta', type=float, default=1)
