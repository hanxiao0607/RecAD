...
def training_procedure(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                       ...
                       beta_2=0.999, use_cuda='cpu', verbose=True, test_data=None, pretrained_senn=None, pretrained_optim=None):
    """
...
def training_procedure_stable(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                              gamma: float, seed=42, num_hidden_layers=1, initial_learning_rate=0.001, beta_1=0.9,
                              beta_2=0.999, Q=20, use_cuda='cpu', verbose=True, display=False):
    """
...
def training_procedure_trgc(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                            gamma: float, seed=42, num_hidden_layers=1, initial_learning_rate=0.001, beta_1=0.9,
                            beta_2=0.999, Q=20, use_cuda='cpu', verbose=True, display=False, true_struct=None,
    ...
    if not signed:
        return a_hat_binary, a_hat_1, coeffs_full_1, senn, optim, senn_2, optim_2
    else:
        return a_hat_binary, a_hat_1, np.squeeze(np.median(coeffs_full_1, axis=0)) * a_hat_binary, coeffs_full_1, senn, optim, senn_2, optim_2